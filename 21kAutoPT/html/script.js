        ...
        if (item.type === "ui") {
            if (item.status == true) {
                ...
                document.getElementById("btn1").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[0]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[0]+'€</p>';
                    ...
                    document.getElementById("rent_btn1").addEventListener("click", function(event){
                        ...
                        $.post('http://21kAutoPT/rentcar', JSON.stringify({
                            car_name : car_name,
                            number : number,
                        }));
                ...
                document.getElementById("btn2").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[1]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[1]+'€</p>';
                ...
                document.getElementById("btn3").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[2]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[2]+'€</p>';
                ...
                document.getElementById("btn4").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[3]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[3]+'€</p>';
                ...
                document.getElementById("btn5").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[4]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[4]+'€</p>';
                ...
                document.getElementById("btn6").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[5]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[5]+'€</p>';
                ...
                document.getElementById("btn7").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[6]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[6]+'€</p>';
                ...
                document.getElementById("btn8").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[7]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[7]+'€</p>';
                ...
                document.getElementById("btn9").addEventListener("click", function(event){
                    ...
                    document.getElementById("nameprice_car").innerHTML='<p class="selected_car"  >Modelo : '+car_names[8]+'</p>'+
                    '<p class="selected_car1" >Preço : '+car_prices[8]+'€</p>';
                ...
                document.getElementById("btn_return").addEventListener("click", function(event){
                    ...
                    $.post('http://21kAutoPT/returncar', JSON.stringify({
                    }));
            ...
            document.onkeyup = function (data) {
                if (data.which == 27  ) {
                    $.post('http://21kAutoPT/exit', JSON.stringify({}));
                    return
                }
            };
